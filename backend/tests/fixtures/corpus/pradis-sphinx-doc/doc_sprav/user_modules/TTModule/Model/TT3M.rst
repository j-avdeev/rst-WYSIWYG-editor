...
Обозначение: |TT3M|
-------------------
.. |TT3M| image:: ../../_image/TTModule.TT3M.png
...
.. csv-table:: **Порты (степени свободы) компонента:**
   ...
   "5","In5", "base.DOF1", "In5"
   "6","In6", "base.DOF1", "In6"
   "7","Out1", "base.DOF1", "Out1"
   "8","Out2", "base.DOF1", "Out2"
   "9","Out3", "base.DOF1", "Out3"
   "10","Out4", "base.DOF1", "Out4"
   "11","Out5", "base.DOF1", "Out5"
   "12","Out6", "base.DOF1", "Out6"
